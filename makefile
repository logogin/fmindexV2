...
#CFLAGS = -g -pg -fprofile-arcs -O9 -W -Wall -Winline -DDEBUG=0
#these are for testing
#CFLAGS = -g -W -Wall -Winline -O9

#these are for maximum speed
CFLAGS=-g -O9 -fomit-frame-pointer -W -Wall -Winline -DDEBUG=0 -DNDEBUG=1 
...
fm_build:	fm_build_main.c fm_index.a ds_ssortr
	$(CC) $(CFLAGS) -o fm_build fm_build_main.c fm_index.a ds_ssort.a
...
example:	build_index_Example.c fm_index.a ds_ssortr
	$(CC) $(CFLAGS) -o bexample build_index_Example.c fm_index.a ds_ssort.a
	
run_queries:	run_queries.c fm_index.a
	$(CC) $(CFLAGS) run_queries.c fm_index.a -o fmi_qshell
	
build_index:	build_index.c fm_index.a ds_ssortr
	$(CC) $(CFLAGS) -o fmi_bshell build_index.c fm_index.a ds_ssort.a

# archive containing fm-library
fm_index.a: fm_mng_bits.o fm_common.o fm_search.o fm_errors.o fm_read.o fm_occurences.o fm_multihuf.o fm_huffman.o fm_extract.o fm_build.o
	ar rc fm_index.a fm_common.o fm_mng_bits.o fm_search.o fm_build.o fm_errors.o fm_read.o fm_occurences.o fm_multihuf.o fm_huffman.o fm_extract.o
	
fm_build.o:	fm_build.c ds_ssort.a fm_common.o fm_mng_bits.o fm_multihuf.o fm_huffman.o fm_occurences.o 
